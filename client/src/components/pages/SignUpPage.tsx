...
// ---------------------------------------------------------------
// SignUpPage — Ultra-premium Socratic Registration Experience
...
export const SignUpPage: React.FC<SignUpPageProps> = ({ onNavigate, onSuccess }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: 'var(--space-6)' }}>
            ...
            >
              Master difficult concepts through real-time simulations and Socratic challenge.
            </p>
          </div>
      ...
      {/* ============================================================ */}
      {/* RIGHT COLUMN: Cinematic Theater Showcase                      */}
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(circle at 80% 20%, rgba(255, 90, 54, 0.2) 0%, transparent 60%), linear-gradient(180deg, rgba(13, 15, 18, 0.4) 0%, rgba(13, 15, 18, 0.88) 100%)',
            pointerEvents: 'none',
          }}
        />
        ...
        <div style={{ position: 'relative', zIndex: 3, maxWidth: '520px' }}>
          ...
          >
            “Lumo turns passive reading into active intuition. Visual simulations that respond to your curiosity in real time.”
          </blockquote>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '14px', fontWeight: 600, color: '#FFFFFF' }}>
                Kinematics · Organic Chemistry · Astrophysics
              </div>
            </div>
            <div
              style={{
